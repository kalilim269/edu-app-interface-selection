...
if(isset($_POST['submit'])){
  ...
  while ($row = $subcriterias->fetch(PDO::FETCH_ASSOC)) {
    ...
    $subcriteriaObj->insert($user, $row['fld_subcriteria_id'], $row['fld_subcriteria_name'], 'C2');
...
if (isset($_POST['delete'])) {
  ...
  header("location: evaluate_subcriteria_2.php");
}
...
<div class="content">
  ...
  <div class="form-style-9">
     ...
     <ol class="breadcrumb" style="background-color: #F0FFFF;">
      ...
      <li class="active">Sub-Criteria (Innovation) Evaluation Table</li>
        ...
        <?php $subbobots2x = $subbobotObj->readAll2($user); while ($baris = $subbobots2x->fetch(PDO::FETCH_ASSOC)): ?>
          <tr>
            ...
            <th style="background-color:#FFD700">
              ...
              $conn = new mysqli('lrgs.ftsm.ukm.my', 'a176496', 'bigwhiterabbit', 'a176496');
                  $sql = "SELECT criteria_em FROM tbl_eduapp_criteria_data WHERE fld_criteria_id='C2' AND user_id=$user";
