...
//header('location: analyse_subcriteria_3.php');
...
<div class="content">
  ...
  <div class="form-style-9">
     ...
     <ol class="breadcrumb" style="background-color: #F0FFFF;">
      ...
      <li class="active">Evaluate Sub-Criteria (Intelligence)</li>
      <li><a href="analyse_subcriteria_3.php">Sub-Criteria (Intelligence) Evaluation Table</a></li>
    </ol>

    <p style="margin-bottom:10px;">
      <strong style="font-size:18pt;"><span class="fa fa-bomb"></span> Evaluate Sub-Criteria - Intelligence</strong>
    </p>

   
    <div class="panel panel-default">
			<div class="panel-body">
				<form method="post" action="analyse_subcriteria_3.php">
            ...
            <?php for ($i=1; $i<=$v; $i++): ?>
              <?php $rows = $subcriteriaObj->readSatu($k); while ($row = $rows->fetch(PDO::FETCH_ASSOC)): ?>
                <div class="row">
                  ...
                  <div class="col-xs-12 col-md-3">
                    <div class="form-group">
                      <?php $pcs = explode("F", $k); $nid = "F".($pcs[1]+$i); ?>
