...
if ($_POST) {
  ...
  $count = $subbobotObj->countAll($user, $_POST['criteria_id']);
}
...
if(isset($_POST['submit'])){
  ...
  foreach ($r as $k => $v) {
    for ($i=1; $i<=$v; $i++) {
      ...
      if ($subbobotObj->insert($_POST[$k.$no], $_POST['nl'.$no], $_POST[$nid.$no], $user, $_POST['criteria_id'])) {
        // ...
      } else {
        $subbobotObj->update($_POST[$k.$no], $_POST['nl'.$no], $_POST[$nid.$no], $user, $_POST['criteria_id']);
      }

      if ($subbobotObj->insert($_POST[$nid.$no], 1/$_POST['nl'.$no], $_POST[$k.$no], $user, $_POST['criteria_id'])) {
        // ...
      } else {
        $subbobotObj->update($_POST[$nid.$no], 1/$_POST['nl'.$no], $_POST[$k.$no], $user, $_POST['criteria_id']);
      }
      $no++;
    }
  }
...
<table width="100%" class="table table-striped table-bordered">
      <thead>
        <tr>
          ...
          <?php $subbobots1 = $subbobotObj->readAll2($user, $_POST['criteria_id']); while ($row = $subbobots1->fetch(PDO::FETCH_ASSOC)): ?>
      ...
      <tbody>
        <?php $subbobots2 = $subbobotObj->readAll2($user, $_POST['criteria_id']); while ($baris = $subbobots2->fetch(PDO::FETCH_ASSOC)): ?>
          <tr>
            <th class="active"><?=$baris['fld_subcriteria_name'] ?></th>
            <?php $subbobots3 = $subbobotObj->readAll2($user, $_POST['criteria_id']); while ($kolom = $subbobots3->fetch(PDO::FETCH_ASSOC)): ?>
              <td>
                <?php
                ...
                if (!isset($_POST['delete'])){
                  ...
                  if ($subbobotObj->insert($baris['fld_subcriteria_id'], '1', $kolom['fld_subcriteria_id'], $user, $_POST['criteria_id'])) {
                    // ...
                  } else {
                    $subbobotObj->update($baris['fld_subcriteria_id'], '1', $kolom['fld_subcriteria_id'], $user, $_POST['criteria_id']);
                  }
      ...
      <tfoot>
        <tr class="info">
          <th>Total</th>
          <?php $stmt5 = $subbobotObj->readAll2($user, $_POST['criteria_id']); while ($row = $stmt5->fetch(PDO::FETCH_ASSOC)): ?>
            <th>
              <?php
    ...
    <table width="100%" class="table table-striped table-bordered">
      <thead>
        <tr>
          ...
          <?php $subbobots1x = $subbobotObj->readAll2($user, $_POST['criteria_id']); while ($row2x = $subbobots1x->fetch(PDO::FETCH_ASSOC)): ?>
      ...
      <tbody>
        <?php $tot=0; $subbobots2x = $subbobotObj->readAll2($user, $_POST['criteria_id']); while ($baris = $subbobots2x->fetch(PDO::FETCH_ASSOC)): ?>
          <tr>
            <th class="active"><?=$baris['fld_subcriteria_name'] ?></th>
            <?php $stmt4x = $subbobotObj->readAll2($user, $_POST['criteria_id']); while ($kolom = $stmt4x->fetch(PDO::FETCH_ASSOC)): ?>
            ...
            <th class="success">
              <?php
              $subbobotObj->readMulti2($baris['fld_subcriteria_id'], $user, $count);
              $b = $subbobotObj->hak2;
    ...
    <table width="100%" class="table table-striped table-bordered">
      ...
      <tbody>
        <?php $total=0; $subbobots1z = $subbobotObj->readAll2($user, $_POST['criteria_id']); while ($row1 = $subbobots1z->fetch(PDO::FETCH_ASSOC)): ?>
          <tr>
...
<?php } ?>
    <a href="gm_eva_alt.php" class="button">Next</a>
    <a style="float: left;" href="gm_criteria.php" class="button">Return</a>
</div>
