...
<table width="100%" class="table table-striped table-bordered">
    ...
    <table width="100%" class="table table-striped table-bordered">
      ...
      <tbody>
        <?php $subbobots2x = $subbobotObj->readAll2($user, $_POST['criteria_id']); while ($baris = $subbobots2x->fetch(PDO::FETCH_ASSOC)): ?>
          <tr>
            <th class="active"><?=$baris['fld_subcriteria_name'] ?></th>
    ...
    <table width="100%" class="table table-striped table-bordered">
      <tbody>
        ...
        <tr>
          ...
          <td><?php
          $subbobotObj->getCI2($user, $cri_id);
          $a=$subbobotObj->nak;
    ...
    <?php } ?>
    <a href="an_eva_alt.php" class="button">Next</a>
