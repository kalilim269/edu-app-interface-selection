...
<div class="content">
  ...
  <div class="form-style-9">
     ...
     <ol class="breadcrumb" style="background-color: #F0FFFF;">
      ...
      <li class="active">Sub-Criteria (Universal Design) Evaluation Table</li>
          ...
          <tr>
            ...
            <th style="background-color:#FFD700">
              ...
              //$conn = new mysqli('lrgs.ftsm.ukm.my', 'a176496', 'bigwhiterabbit', 'a176496');
                  $sql = "SELECT criteria_em FROM tbl_eduapp_criteria_data WHERE fld_criteria_id='C1' AND user_id=$user";
    ...
    <a href="evaluate_subcriteria_2.php" class="button">Next</a>
</div>
