...
<div class="content">
  ...
  <div class="form-style-9">
      ...
      <li class="active">Evaluate Sub-Criteria (Innovation)</li>
      <li><a href="analyse_subcriteria_2.php">Sub-Criteria (Innovation) Evaluation Table</a></li>
    </ol>

    <p style="margin-bottom:10px;">
      <strong style="font-size:18pt;"><span class="fa fa-bomb"></span> Evaluate Sub-Criteria - Innovation</strong>
    </p>

   
    <div class="panel panel-default">
			<div class="panel-body">
				<form method="post" action="analyse_subcriteria_2.php">
					<div class="row">
            ...
            <?php for ($i=1; $i<=$v; $i++): ?>
              <?php $rows = $subcriteriaObj->readSatu($k); while ($row = $rows->fetch(PDO::FETCH_ASSOC)): ?>
                <div class="row">
                  ...
                  <div class="col-xs-12 col-md-3">
                    <div class="form-group">
                      <?php $pcs = explode("D", $k); $nid = "D".($pcs[1]+$i); ?>
