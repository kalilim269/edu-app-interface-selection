...
<div class="content">
  ...
  <div class="form-style-9">
          <h2 style="text-align: center;font-size: 25px;"><b>Criteria</b></h2>
          <div class="form-style-8">
          <h2 style="font-size: 20px; margin-left: 10px;"><b>Recommended Data: </b></h2>
          <h2 style="margin-top: 40px;"><b>1. Universal Design</b>
          <!--<a href="#" class="button">Evaluate</a></h2>-->

          <!--<hr style="border-top: 5px solid black;">-->
          <h2 style="margin-top: 40px;"> <b>2. Innovation</b><!--<a href="#" class="button">Evaluate</a></h2>-->

          <!--<hr style="border-top: 5px solid black;">-->
          <h2 style="margin-top: 40px;"><b>3. Intelligence</b></h2>
          <hr style="border-top: 5px solid black;">
          <a href="criteria_data.php" class="button">Proceed</a>
