...
<div class="content">
  ...
  <div class="form-style-9">
     ...
     <ol class="breadcrumb" style="background-color: #F0FFFF;">
      ...
      <li><a href="an_sub2.php">Sub-Criteria (Innovation)</li>
      <li><a href="an_sub3.php">Sub-Criteria (Intelligence)</a></li>
      <li class="active">Select Alternative</a></li>
    ...
    <div class="panel panel-default">
      <div class="panel-body">
        <form method="post" action="an_alt.php">
        	<div class="row">
          ...
          <a href="an_sub3.php" class="button">Return</a>
        </form>
      </div>
    </div>
  </div>
