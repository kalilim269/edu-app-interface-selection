...
if ($_POST) {
  ...
  $criObj->id = $_POST['criteria_id'];
  $criObj->name = $_POST['name'];

  if ($criObj->insert($user)) { ?>
  ...
  <div class="form-style-9">
    ...
    <!--<ol class="breadcrumb" style="background-color: #F0FFFF;">
      ...
      <li><a href="analyse_criteria.php">Criteria Evaluation Table</a></li>
          ...
          <h2 style="text-align: center;font-size: 25px;"><b>Add Criteria</b></h2>
        ...
        <div class="form-group">
          <br>
            <label for="id_kriteria">Criteria ID</label>
            <input type="text" class="form-control" id="criteria_id" name="criteria_id" required readonly="on" value="<?=$criObj->getNewID($user)?>">
          </div>
          <div class="form-group">
