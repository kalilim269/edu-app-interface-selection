      ...
      <thead>
        ...
        <tr class="success">
          <?php $bobot1 = $ranObj->readPrioC1($user); while ($row = $bobot1->fetch(PDO::FETCH_ASSOC)): ?>
            ...
            <td colspan="<?php $subcri1a = $subcriObj->readAll2($user, $row['fld_criteria_id']); echo $subcri1a->rowCount(); ?>" class="text-center"><?=number_format($row['criteria_em'], 4, '.', ',')?></td> 
