    ...
    <table width="100%" class="table table-striped table-bordered">
      <tbody>
        ...
        <tr>
          <th>CR</th>
          <td><?php 
          if ($ir != 0){$cr = $ci/$ir; echo number_format($cr, 4, '.', ',');} else {echo '0';}?></td>
        </tr>
      </tbody>
    </table>
    <a href="an_sub3.php" class="button">Next</a>
    <a style="float:left" href="an_sub1.php" class="button">Return</a>
</div>
