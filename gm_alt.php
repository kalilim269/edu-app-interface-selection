...
<table width="100%" class="table table-striped table-bordered">
     ...
     <table width="100%" class="table table-striped table-bordered">
        ...
        <tbody>
          <?php $tot=0; $alt2b = $altObj->readByFilter(); while ($baris = $alt2b->fetch(PDO::FETCH_ASSOC)): ?>
            <tr>
              <th class="active"><?=$baris['alt_name']?></th>
            ...
            $skoObj->readMulti2($baris['alt_id'], $altsubcriteria, $user);
            $a = $skoObj->hak2;
      ...
      <table width="100%" class="table table-striped table-bordered">
        ...
        <tbody>
          <?php $total=0; $alt2b = $altObj->readByFilter(); while ($baris = $alt2b->fetch(PDO::FETCH_ASSOC)): ?>
            <tr>
              <th class="active"><?=$baris['alt_name']?></th>
              <?php $alt3b = $altObj->readByFilter(); while ($kolom = $alt3b->fetch(PDO::FETCH_ASSOC)): ?>
        ...
        <tr>
          ...
          <th><?php $result = $total; echo number_format($result, 4, '.', ','); ?></th>
        </tr>
      </tfoot>
      </table>
