...
<div class="content">
  ...
  <div class="form-style-9">
     ...
     <ol class="breadcrumb" style="background-color: #F0FFFF;">
      ...
      <li class="active">Alternative</a></li>
...
<table width="100%" class="table table-striped table-bordered">
              ...
              <?php $alt3a = $altObj->readByFilter($user); while ($kolom = $alt3a->fetch(PDO::FETCH_ASSOC)): ?>
                ...
                <?php
                  ...
                  //} 
                    ...
                    $skoObj->insert($baris['alt_id'], '0', $kolom['alt_id'], $altsubcriteria, $user);
                  }
                }
                  else {
     ...
     <table width="100%" class="table table-striped table-bordered">
        ...
        <tbody>
          <?php $tot=0; $alt2b = $altObj->readByFilter($user); while ($baris = $alt2b->fetch(PDO::FETCH_ASSOC)): ?>
            <tr>
              <th class="active"><?=$baris['alt_name']?></th>
              ...
              <th class="info">
                ...
                $skoObj->readMulti($baris['alt_id'], $altsubcriteria, $user);
                $prioritas = $skoObj->hak;
                //$skoObj->insert7($prioritas, $baris['id_alternatif'], $altsubcriteria);
                //echo sprintf('%E', $prioritas);
            ...
            <?php 
            //$skoObj->readKriId($altsubcriteria);
            $skoObj->readMulti2($baris['alt_id'], $altsubcriteria, $user, $count2);
            $a = $skoObj->hak2;
            $skoObj->insert7($a, $baris['alt_id'], $user);
      ...
      <table width="100%" class="table table-striped table-bordered">
        ...
        <tbody>
          <?php $total=0; $alt2b = $altObj->readByFilter($user); while ($baris = $alt2b->fetch(PDO::FETCH_ASSOC)): ?>
            <tr>
              <th class="active"><?=$baris['alt_name']?></th>
              <?php $alt3b = $altObj->readByFilter($user); while ($kolom = $alt3b->fetch(PDO::FETCH_ASSOC)): ?>
              ...
              <th class="success">
                ...
                $skoObj->readAll4($baris['alt_id'], $altsubcriteria, $user);
                $prioritas = $skoObj->prio;
                $prio = $prioritas/$tot;
                $skoObj->insert8($prio, $baris['alt_id'], $altsubcriteria, $user);
                echo number_format($prio, 4, '.', ',');
            ...
            $skoObj->readSubPriGm($altsubcriteria, $user);
            $a = $skoObj->sub;
            ...
            <th style="background-color:#00CED1">  
              ...
              <?php
              //$skoObj->readAvg($baris['id_alternatif'], $altsubcriteria);
                //$prioritas = $skoObj->hak;
                ...
                $a = $skoObj->sub;
                $b = $prio*$a;
                $skoObj->insert9($b, $baris['alt_id'], $altsubcriteria, $user);
        ...
        <tr>
          ...
          <th><?php $result2 = $total; echo number_format($result2, 4, '.', ','); ?></th>
        </tr>
      </tfoot>
      </table>
      ...
      <a style="float: right;" href="gm_result.php" class="button">Next</a>
       <a href="gm_eva_alt.php" class="button">Return</a>
</div>
...
<?php } else {
  echo "<script>location.href='gm_eva_alt.php'</script>";
}
